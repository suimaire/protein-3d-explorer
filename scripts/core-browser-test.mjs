...
try{
 ...
 const nav=page.getByRole('navigation',{name:'학습 모듈'});assert.equal(await nav.getByRole('button').count(),4);
 ...
 check('Four completed modules; Hydrophobic Core loads 1UBQ chain A in WebGL (ribbon, default, all 76)');
